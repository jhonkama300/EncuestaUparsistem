...
export function AdminView({ user, onLogout }: AdminViewProps) {
  const [activeTab, setActiveTab] = useState<"surveys" | "students" | "ponentes" | "statistics">("surveys")
          ...
          >
            <CardHeader>
              <div className="flex items-center gap-3">
                <div
                  className={`h-12 w-12 rounded-lg flex items-center justify-center ${
                    activeTab === "statistics" ? "bg-emerald-600 text-white" : "bg-emerald-100 text-emerald-600"
                  }`}
                >
